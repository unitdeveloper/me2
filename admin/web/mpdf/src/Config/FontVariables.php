	...
	public function __construct()
	{
		$this->defaults = [
			...
			'fontdata' => [
				...
				"courierthaimono" => array(
					'R' => "../../../../admin/web/fonts/COURMT__.TTF",
				),
				"freesiaupc" => array(
					'R' => "../../../../admin/web/fonts/FreesiaUPC.ttf",
				),
				"basis" => array(
					'R' => "../../../../admin/web/fonts/basis.ttf",
				),
				"chulajaruek" => array(
					'R' => "../../../../admin/web/fonts/CHULAJARUEK.ttf",
				),
				"thaimono" => array(
					'R' => "../../../../admin/web/fonts/thaimono.ttf",
				),
				 
				"saraban" => array(
					'R' => "../../../../admin/web/fonts/thsarabunnew-webfont.ttf",
					'B' => "../../../../admin/web/fonts/thsarabunnew_bold-webfont.ttf",
					'I' => "../../../../admin/web/fonts/thsarabunnew_italic-webfont.ttf",
					'BI' => "../../../../admin/web/fonts/thsarabunnew_bolditalic-webfont.ttf"
				),
				 
				"kanit" => array(
					'R' => "../../../../admin/web/fonts/Kanit-Regular.ttf",
				),
				"fontawesome" => array(
					'R' => "../../../../admin/web/fonts/font-awesome/fonts/fontawesome-webfont.ttf",
				),
