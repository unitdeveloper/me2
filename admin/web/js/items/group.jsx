class SaleChart extends React.Component {
 ...
 getDataChart = (data) => { 
  ...
  tableRender = (model) => {
    ...
    return (
        <tr key={model.id}>
            <td><img src={model.img} className="img-responsive" width="50"/></td>
            <td>{model.name}</td>          
            ...
            <td className="text-right hidden-xs" width="210px">
                <a className="btn btn-sm btn-default btn-flat" href={'?r=salepeople%2Fpeople%2Fview&id='+model.id} target="_blank"><i className="far fa-edit"></i></a>
...
ReactDOM.render(
  <SaleChart />,
  document.getElementById('itemGroup')
);
