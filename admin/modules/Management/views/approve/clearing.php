                ...
                $gridColumns = [
                    ...
                    [
                        ...
                        'value' => function($model){
                            ...
                            $app.= '<div class="bg-content text-center" style="background-image:url(uploads/'.$model->banklist->imageFile.');"><span>'.Yii::t('common',$model->type).'</span></div>';
                    ...
                    [
                        ...
                        'value' => function($model){
                            ...
                            $app = '<div class="show-dialog-click  col-xs-12 btn-flat" style="font-size:16px;">'.number_format($sumBl,2).'</div>';
