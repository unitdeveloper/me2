 ...
 */
class SearchPicItems extends Items
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query
            ->andFilterWhere(['like', 'Description', $this->Isearch])
            ...
            ->andFilterWhere(['like', 'barcode', $this->Isearch])
            //->andFilterWhere(['like', 'CostingMethod', $this->CostingMethod])
            ->andFilterWhere(['like', 'master_code', $this->Isearch])

           //->andFilterWhere(['like', 'ProductionBom', $this->ProductionBom]);

           ->andFilterWhere(['like', 'No', $this->Isearch]);
