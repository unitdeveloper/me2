...
class LocationController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            $model->save();
            if($model->defaultlocation){
                Location::updateAll(['defaultlocation' => $model->defaultlocation == 1 ? 0 : 1], 'comp_id ='.Yii::$app->session->get('Rules')['comp_id'].' and id !='.$model->id);
            }
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if($model->defaultlocation){
                Location::updateAll(['defaultlocation' => $model->defaultlocation == 1 ? 0 : 1], 'comp_id ='.Yii::$app->session->get('Rules')['comp_id'].' and id !='.$id);
            }
