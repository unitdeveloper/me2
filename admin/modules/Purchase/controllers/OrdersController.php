...
class OrdersController extends Controller
{
    ...
    public function actionPrint($id){
        ...
        $defineHeader = [           
            ...
            '{DOCUMENT_NO}'         => $countRow > 0 ? $model->doc_no : '',
            ...
            '{DELIVERY_SCHEDULE_TH}'=> date('d/m/y',strtotime($model->delivery_date.' + 543 Years')),
    ...
    public function actionJsonCreateItemLine()
    {
        ...
        $lastPrice  = $model->getLastprice(Yii::$app->request->post('itemId'));
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            //if(!$model->completeReceive){
                ...
                try {                
                    ...
                    if($header !==null){                    
                        foreach (Yii::$app->request->post('location') as $key => $value) {
