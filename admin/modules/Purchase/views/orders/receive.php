...
<div class="row">
    ...
    <div class="col-sm-4">
        <?= $form->field($model,'delivery_date')->textInput(['value' => date('Y-m-d'),'readonly' => true,'placeholder' => Yii::t('common','Receive Date').'...',])->label(Yii::t('common','Receive Date'))?>
        <?php /* $form->field($model, 'delivery_date')->widget(DatePicker::classname(), [
                                                 'options' => [
...
$(document).ready(function(){
    ...
    $('.checkbox-row').click(function(event) {
        ...
        $(this).closest('tr').find('input.qty-to-receive').val(qty);
    });   
})
