...
<div role="tabpanel">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation">
            <a href="#tab" aria-controls="tab" role="tab" data-toggle="tab"><i class="fab fa-windows"></i> Preview</a>
        </li>
    </ul>
    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="home">
            ...
            <div id="FOOTER" class="collapse in">
                <div class="row">
                    <div class="col-md-10  col-sm-9">                
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div id="SIGNATURE" class="collapse in">
                        <div class="row">
                        <div class="col-md-10  col-sm-9">             
            ...
            <div id="WATER-MARK" class="collapse">
                                ...
                                <div style="width:90%; margin-left:10px;">
                                    <div class="row" style="border-top:1px dotted #000; border-left:1px dotted #000; height:200px;">
                                        ...
                                        <div class="col-xs-5 col-md-3">
                                            ...
                                            <?=$form->field($model,'water_mark_left')->textinput(['placeholder' => '50%','style' => 'width:50px;text-align:center;'])->label('<i class="fas fa-arrow-left "></i>')?></div>
                                        </div>
                                        <div class="col-xs-7 col-md-9">
                                            
                                            <div class="" > <?=$form->field($model,'water_mark_top')->textinput(['placeholder' => '50%','style' => 'width:50px;'])
...
<?php //$this->registerJsFile('@web/skins/moono-lisa/skin.js',$Options) ?>
