        ...
        'columns' => [
            ...
            [
                ...
                'value' => function($model){
                    return Html::a($model->name,['/setting/printer-editable', 'page' => $model->module]);
                    //setting%2Fprinter-editable&page=purchase_header
            ...
            [
                ...
                'template'=>'<div class="btn-group btn-group text-center" role="group">   {update}  </div>',
                ...
                'buttons'=>[
                    ...
                    'view' => function($url,$model,$key){
                        return Html::a('<i class="fas fa-eye"></i> '.Yii::t('common','View'),['/setting/printer-editable', 'page' => $model->module],['class'=>'btn btn-default']);
                    },
                    ...
                    'update' => function($url,$model,$key){
                        return Html::a('<i class="far fa-edit"></i> '.Yii::t('common','Update'),['/setting/printer-editable', 'page' => $model->module],['class'=>'btn btn-success']);
                    }
