...
<div class="purchase-header-form" ng:controller="purchaseOrder">
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="row ">
                        ...
                        <div class="col-xs-12 col-sm-6">
                          ...
                          ])->textInput(['maxlength' => true,'placeholder' => Yii::t('common','Ship Address')])->label(Yii::t('common','Ship Address')) ?>
                        </div>
        ...
        <div class="col-sm-5">
          <div class="vendorFilter">
              <?=$form->field($model,'vendor_name',
               ...
               ])->textInput(['class' => 'VENDOR-PICKER','placeholder' => Yii::t('common','Please select a vendor.'),'autocomplete' => 'off'])?>
            </div>
    ...
    <div class="row">
      ...
      <div class="col-xs-12 text-right">
        <a class="btn btn-success-ew" data-toggle="modal" href='#ew-modal-source'><i class="fa fa-plus"></i> <?=Yii::t('common','Get source document')?></a>
        <span class="pointer  text-primary" data-toggle="collapse" data-target="#order-project">
      ...
      <table class="table   table-bordered sortable" id="Purchase_Line">
        ...
        <tbody >
          <tr ng:repeat="model in PurchaseLine  | orderBy : 'priority'" data-key="{{model.id}}">
            ...
            <td>
              <select ng-model="model.measure" ng-disabled="model.complete_rec"  class="form-control field-update" ng-change="getTotalSummary()" name="unit_of_measure" id="unit_of_measure" >                  
  ...
  <div class="modal  fade" id="ew-modal-source" role="dialog" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog " style="width:95%">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a type="button" class="btn btn-info ew-get-ship"   ng-click="openModalConfirmReq()"   > <i class="fa fa-check"></i>  <?=Yii::t('common','Select')?></a>
        </div>
      </div>
    </div>
  </div>
...
<?php $this->registerJsFile('@web/js/purchase/vendors.js?v=4.06.11');?>
<?php $this->registerJsFile('@web/js/purchase/order.js?v=4.06.11');?>
<?php $this->registerJsFile('@web/js/purchase/purController.js?v=4.06.21.11');?>
