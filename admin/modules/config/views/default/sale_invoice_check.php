...
<div class="row">
    <div class="col-sm-12">
        ...
        <?php if(!isset($_GET['table'])) : ?>
            ...
            <a href="index.php?r=config/default/sale-invoice-check&action=fixed&session=<?=base64_encode(date('His'))?>" onclick="return confirm('Are you sure, you want to calibrate it?')" class="btn btn-warning-ew">
