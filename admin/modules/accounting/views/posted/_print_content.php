...
<table border="0" cellpadding="2" cellspacing="0"  width="100%"  style="width: 100%;">
  <thead >
    <tr >
      ...
      <th style="" align="left" ><span style="{$showHeader}">{$Yii::t('common','No')}</span></th>
      <th style="" align="left" ><span style="{$showHeader}">{$Yii::t('common','Detail')}</span></th>
      <th style="" align="center"><span style="{$showHeader}">{$Yii::t('common','Quantity')}</span></th>
      <th style="" align="center"><span style="{$showHeader}">{$Yii::t('common','Price/Unit')}</span></th>
      <th style="" align="center"><span style="{$showHeader}">{$Yii::t('common','Discount')}</span></th>
      <th style="padding-right:5px;" align="center"><span style="{$showHeader}">{$Yii::t('common','Total')}</span></th>
    </tr>
</thead>
<tbody>
HTML;
    ...
    foreach ($data[$i] as $line) {
        ...
        $td.= '<tr>';
            ...
            $td.= '<td valign="top" class="item item-code">'.($line->code_no_=='1^x' ? ' ' : $line->items->master_code).'</td>';
            $line->code_desc_==''
