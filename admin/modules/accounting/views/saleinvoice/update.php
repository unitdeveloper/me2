...
<div id="contextMenu" class="dropdown clearfix" style="">
	<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu" style="display:block;position:static;margin-bottom:5px; ">
		...
		<li><?= Html::a('<i class="fa fa-trash-o text-danger" aria-hidden="true"></i> '.Yii::t('common', 'Delete'), ['delete', 'id' => $model->id], [
		    'class' => '',
		    'data' => [
		...
		<li>
			<a tabindex="-1" href="index.php?r=accounting/saleinvoice/view&id=<?=$_GET['id']?>"><i class="fa fa-info text-info" aria-hidden="true"></i> <?=Yii::t('common','Properties')?></a>
		</li>
		...
		<li>
			<?php 
                ...
                $isVat       	= $GenSeries->InfoSeries('vat_type','vat_value',$model->vat_percent,false);
				if($isVat):
			?>
    ...
    $('.edit-Runing-Series').click(function(){
        ...
        $.ajax({ 
            ...
            success:function(getData){
                ...
                $('.data-body').attr('style','height: 680px;overflow-y: auto;'); 
