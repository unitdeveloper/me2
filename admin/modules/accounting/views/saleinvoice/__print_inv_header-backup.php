 ...
 <div class="footer">
    <table style="width:100%; font-size: 13px;" border="0" cellpadding="0" cellspacing="0" >
        ...
        <tr>
            ...
            <td class="beforediscount" align="right"  valign="top" style="height: 30px;">               
                <b><?= number_format($model->discount,2) ?> </b>
            </td>             
        </tr>
        <tr>
            ...
            <td class="discount" align="right" valign="top" style="height: 30px; ">                 
                                
            </td>           
            <td class="subtotal"  align="right"  valign="top" >
                <b>
