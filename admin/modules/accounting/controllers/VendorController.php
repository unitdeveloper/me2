...
class VendorController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        return $this->render('@admin/modules/vendors/views/vendors/index', [
    ...
    public function actionView($id)
    {
        ...
        return $this->render('@admin/modules/vendors/views/vendors/view', [
    ...
    public function actionAjaxFindVendor(){
      ...
      if(isset($_POST['cond'])){
        if($_POST['cond']!=''){
          ...
          ->andWhere(['like','name', explode(' ',$_POST['cond'])])
          ->limit(20)
          ->all();
        }
      ...
      if($query){
          ...
          foreach ($query as $key => $model) {
            ...
            $data.= '<li>
                      <div class="row">
                        <div class="col-xs-12">
                          <span class="selected" key="'.$model->id.'" data="'.$model->name.'" style="cursor:pointer;" ng-click="pickCompany()">
                            <i class="fa fa-id-card-o text-aqua" aria-hidden="true"></i> '.$model->name.'
                          </span>
                        </div>
...
HTML;
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            return $this->render('@admin/modules/vendors/views/vendors/create', [
                'model' => $model,
            ]);
        }
    }
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if(!$model->save()){
              ...
              return $this->render('@admin/modules/vendors/views/vendors/update', [
                  'model' => $model,
              ]);
            }
            return $this->redirect(['view', 'id' => $model->id]);
