...
/**
 * SaleinvheaderController implements the CRUD actions for SaleInvoiceHeader model.
 */
class SaleinvheaderController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new SaleinvheaderSearch();
