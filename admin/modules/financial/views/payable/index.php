...
$this->params['breadcrumbs'][] = ['label' => Yii::t('common', 'Payment'), 'url' => ['index']];
...
<?php 
        $gridColumns = [
            ...
            [
              ...
              'format' => 'html',
              'footerOptions' => ['class' => 'text-right','style' => 'position:relative;'],
            	'value' => function($model){
              ...
              'footer' => (@$_GET['total-summary']=='all') ? '
                  <div style="padding-top:92px; position:absolute; right:2px;" >
...
HTML;
            ...
            <div class="col-sm-2 col-xs-4"> 
             ...
             <div class="col-md-3  col-xs-8">
                  ...
                  <label><?=Yii::t('common','Vendors')?></label>
                        <?php
