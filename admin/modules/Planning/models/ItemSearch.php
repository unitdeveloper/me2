 ...
 */
class ItemSearch extends ItemMystore
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'item', 'user_modify', 'user_added', 'comp_id', 'unit_of_measure', 'clone', 'status', 'stock_adjust'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'stock_adjust' => $this->stock_adjust,
        ]);
