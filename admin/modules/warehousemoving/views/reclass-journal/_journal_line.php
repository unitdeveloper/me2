    ...
    $gridColumns = [
            ...
            [
                ...
                'value' => function($model){
                    if($model->source_id!='')
                    {
                        $Header         = \common\models\ItemReclassJournal::findOne($model->source_id);
            ...
            [
                ...
                'value' => function($model){
                    return Html::textInput('ItemReclassJournalLine[Quantity]['.$model->id.']',$model->Quantity * 1,
                    [
                        'type' => 'number',
                        'class' => 'form-control text-right journal-qty option-change',
                        'field-name' => "Quantity",
                        'style' => 'width:90px;'
                    ]);
                },
            ...
            [
                ...
                'value' => function($model){
                    ...
                    return Html::activeDropDownList($model, 'unit_of_measure['.$model->id.']', 
                            ...
                            [
                                'class' => 'form-control option-change',
                                'field-name' => "unit_of_measure",
                                'value' => $model->unit_of_measure,
                            ]
                    );
                },
                'footer' => ' ',
            ...
            [
                ...
                'value' => function($model){
                    ...
                    return Html::textInput('ItemReclassJournalLine[unit_price]['.$model->id.']',$model->unit_price * 1,['type' => 'number','class' => 'form-control text-right','style' => 'width:120px;']);
                },
                'footer' => '<div class="">
            ...
            [
                ...
                'value' => function($model){
                    ...
                    return Html::activeDropDownList($model, 'location['.$model->id.']',
                            ...
                            [
                                'class'=>'form-control option-change bg-warning',
                                'field-name' => 'location',
            ...
            [
                'format' => 'html',
                'contentOptions' => ['class' => 'text-center','style' => 'padding-top:15px;'],
                'value' => function($model){
                   
                    return '<i class="fas fa-arrow-right '.(($model->location===$model->to_location)? "blink text-red" : "text-green").'"></i>';
                }
            ],
            [
                'label' => Yii::t('common','To Store'),
                'format' => 'raw',                 
                'value' => function($model){
                    ...
                    return Html::activeDropDownList($model, 'to_location['.$model->id.']',
                            ArrayHelper::map($model->locationsList, 'id', 'code'),
                            [
                                'class'=>'form-control option-change bg-info ',
                                'field-name' => 'to_location',
                                'style' => ($model->location===$model->to_location)? 'border:1px dotted red;' : 'border:1px solid green;',
                                'value' => $model->to_location,
                            ]
                    );
