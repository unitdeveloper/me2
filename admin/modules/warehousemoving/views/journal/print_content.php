...
<table border="0" cellpadding="2" cellspacing="0"  width="100%"  style="width: 100%;">
  <thead>
    <tr>
      ...
      <th style="font-size:12px; padding-right:-5mm;" align="left">{$Yii::t('common','Location')}</th>
      <th style="font-size:12px; padding-right:-5mm;" align="center">{$Yii::t('common','Quantity')}</th>
      <th style="font-size:12px; padding-right:-5mm;" align="left">{$Yii::t('common','Measure')}</th>
