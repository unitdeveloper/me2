...
<div id="accordianId" role="tablist" aria-multiselectable="true" class="hidden">
    <div class="card">
        <div class="card-header" role="tab" id="section1HeaderId">
            <h4 class="mb-0">
                <a data-toggle="collapse" data-parent="#accordianId" href="#section1ContentId" aria-expanded="true" aria-controls="section1ContentId">Product</a>
            </h4>
        </div>
...
<?php $this->registerJsFile('js/warehouse/journal.js?v=3.06.21.1');?>
...
<?=$this->render('@admin/modules/SaleOrders/views/modal/_pickitem',['model' => $model]) ?>
