	...
	<div class="navbar-collapse- js-navbar-collapse-">
		<ul class="nav navbar-nav">
			<li class="dropdown dropdown-large">
				<a href="javascript:void(0);" class="dropdown-toggle add-product-service" data-toggle="dropdown"><i class="fa fa-plus text-primary"></i> <?= Yii::t('common','Add Product / Service');?> <b class="caret"></b></a>
				
				<ul class="dropdown-menu dropdown-menu-large row" style="border:5px solid rgba(111,52,196, .5); ">
          <?php                
           $menuList = Itemgroup::find()->where([
              'Child' => '00', 
              'status' => 1, 
           ...
           $dropdown = '';
              ...
              if($count>0){
                $dropdown.= '<li class="col-sm-3">
                              <ul>
                                <li class="dropdown-header"> <i class="fa fa-caret-down pull-left" aria-hidden="true"></i>'. Yii::t('common',$model->Description) . '</li>                  
