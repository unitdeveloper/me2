...
/**
 * reclassJournalSearch represents the model behind the search form of `common\models\ItemJournal`.
 */
class reclassJournalSearch extends ItemReclassJournal
{
    /**
     * @inheritdoc
     */
