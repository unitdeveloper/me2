        ...
        <?php
            $gridColumns = [
                ...
                [
                    ...
                    'format' => 'raw',
                    'headerOptions' => ['class' => 'hidden-xs','style' => 'min-width:150px; width:120px;'],
                    'contentOptions' => ['class' => 'hidden-xs'],
                    'footerOptions' => ['class' => 'hidden-xs'],
                    'value' => function($model){
                        return '<input type="text" value="'.$model->remark.'" class="form-control text-line update-desc" name="remark" />';
                    },
                ...
                //     'format' => 'raw',  
                //     'headerOptions' => ['class' => ' ','style' => 'min-width:120px; width:120px;'],               
                //     'value' => function($model){
     
                //         return Html::activeDropDownList($model, 'source_type['.$model->id.']', [
                //             '1' => Yii::t('common', 'Return to customer'),
                //             '2' => Yii::t('common', 'Receive All')
                //         ]);
