...
<table border="0" cellpadding="2" cellspacing="0"  width="100%"  style="width: 100%;">
  <thead>
    <tr>
      ...
      <th style="" align="right" style="padding-right:5px;">{$Yii::t('common','Quantity')}</th>
      <th style="" align="left" style="padding-left:5px;">{$Yii::t('common','Comment')}</th>
...
HTML;
    ...
    foreach ($data[$i] as $line) {
        ...
        $td.= '<tr>';
            ...
            $td.= '<td valign="top" class="item "  width="105"  align="left" style="padding-left:5px;">'.$line->remark.'</td>';

            $td.= '<td valign="top" style="padding-right:15px;" class="item  " width="50" align="right">'.number_format($line->quantity * $line->unit_price).'</td>';
