                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="input-group">
                            <input type="number" step="any"  id="ew-discount-percent" value="<?=number_format($model->percent_discount,2);?>" data="<?=$model->percent_discount;?>" class="form-control money" style="text-align: right;"> 
                            <span class="input-group-addon">%</span>
                        </div>
                    </div>
                    <div class="col-xs-6">                        
                        <input type="text" id="ew-discount-amount" value="<?=number_format($SumTotal->discount,2);?>" data="<?=$SumTotal->discount;?>"  class="form-control" style="text-align: right;" autocomplete="off"> 
                    </div>
                </div> 
