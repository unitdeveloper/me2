                    ...
                    <div class="panel-group" id="accordion" style="margin-bottom: 150px;">
                        <div class="panel panel-primary">
                            ...
                            <div id="collapse1" class="panel-collapse collapse in">
                                ...
                                <div class="row">                                        
                                    <div class="col-sm-10">
                                        <h4><?=Yii::t('common','Production')?></h4>
                                        <div class="production-no" class="text-red">PDR-02-0001</div>
...
$js=<<<JS
 ...
 let homehub = {
    ...
    code_color: "{$homehub->code_color}",
    qty_color: "{$homehub->qty_color}",
    sumline_color: "{$homehub->sumline_color}"
 };
...
<?php $this->registerJsFile('@web/js/saleorders/reserve.js?v=5.07.21.3', ['depends' => [\yii\web\JqueryAsset::className()]]); ?>
