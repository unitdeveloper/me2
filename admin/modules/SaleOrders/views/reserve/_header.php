    ...
    <div class="col-sm-5 col-md-6"> 
        <div class="row">
            <div class="col-xs-6 col-sm-4" >
                <?php /* $form->field($model, 'business_type')->widget(Select2::classname(),[
                    'name' => 'customer',
        ...
        <div class="box-tools">
            <div class="input-group  "  style="margin-bottom: 20px;" >
                ...
                <div class="input-group-btn">
                    ...
                    <a href="index.php?r=SaleOrders%2Freport%2Fsale-order-modern-trade" class="btn btn-default transport-click" target="_blank"><i class="fas fa-shipping-fast"></i></a>
                </div>
            </div>
        </div>
    </div>
