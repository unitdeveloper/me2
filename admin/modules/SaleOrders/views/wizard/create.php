    ...
    <section>
        <div class="wizard">
            <div class="wizard-inner wizard-4">
                ...
                <ul class="nav nav-tabs" role="tablist" style="background: #45465c; margin-top: -35px;">
            ...
            <div class="tab-content col-xs-12 ">
                        ...
                        <div class="panel panel-success">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse1"><?=Yii::t('common','Summary')?></a>
                                </h4>
                            </div>
                            <div id="collapse1" class="panel-collapse collapse in">
                                    <div class="row text-center">
                                        ...
                                        <div class="col-sm-8 my-10">
                                            <div  style="border:1px solid #ccc; min-height: 70px;">
                                                <h4 class="cust-code my-10"></h4>
                                                <h4 class="my-10"><span class="cust-name"></span></h4>
                                            </div>
                                        </div>
                                        <div class="col-sm-2"></div>
                                    </div>
                                    ...
                                    <h4><?=Yii::t('common','Show status of stock movement')?></h4>
                ...
                <div class="tab-pane" role="tabpanel" id="complete">
                    <div class="text-center">
                        ...
                        <div class="row">
                            <div class="col-sm-12 my-10">
                                <h4 class="cust-code my-10"></h4>
                                <h4 class="my-10"><?=Yii::t('common','Customer')?> :   <span class="cust-name"></span></h4>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <ul class="list-inline pull-right">
                        <li><?=Html::a('<i class="fas fa-power-off"></i> '.Yii::t('common','Close'),['/SaleOrders/wizard/index'],['class' => 'btn btn-default-ew text-gray'])?></li>
                        <li><?=Html::a('<i class="far fa-plus-square"></i> '.Yii::t('common','New'),['/SaleOrders/wizard/create','now' => date('YmdHis')],['class' => 'btn btn-success-ew text-gray'])?></li> 
                    </ul>
                </div>
...
<?php $this->registerJsFile('@web/js/saleorders/wizard.js?v=4.06.21.2', ['depends' => [\yii\web\JqueryAsset::className()]]); ?>
<?php $this->registerJsFile('@web/js/saleorders/import.js?v=4.11.22', ['depends' => [\yii\web\JqueryAsset::className()]]); ?>
<?php $this->registerJsFile('@web/js/saleorders/editable.js?v=4.11.22', ['depends' => [\yii\web\JqueryAsset::className()]]); ?>
