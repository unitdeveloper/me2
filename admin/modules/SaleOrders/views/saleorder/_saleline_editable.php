                                  ...
                                  [
                                    ...
                                    'value' => function($model){
                                      ...
                                      if($model->description==''){
                                        $desc = $model->itemstb['description_th'];
                                      }else {
                                  ...
                                  [
                                    ...
                                    'label' => Yii::t('common','Unit Price'),
                                     ...
                                     'value' => function($model){
                                        ...
                                        return '<input type="number" step=any value="'.($model->unit_price *1).'" class="form-control text-right money text-line update-unit_price" name="unit_price">';
                                     },
                                     //'footer' => 'รวม',
