 ...
 */
class WizardSearch extends SaleHeader
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['status','remark','transport','sale_id', 'Invoice', 'Shipment'],'string'],
        ];
    }
    ...
    public function search($params)
    {
        $query = SaleHeader::find()
                ...
                ->leftJoin('warehouse_header','warehouse_header.SourceDocNo=sale_header.id')
        ...
        $dataProvider->sort->attributes['Shipment'] = [
            'asc' => ['warehouse_header.DocumentNo' => SORT_ASC],
            'desc' => ['warehouse_header.DocumentNo' => SORT_DESC],
        ];
        ...
        $query->andFilterWhere(['or',
                                ...
                                ['like','warehouse_header.DocumentNo',trim($this->search)]
                            ])
